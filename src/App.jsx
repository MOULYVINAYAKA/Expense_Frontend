...
const App = () => {
  ...
  useEffect(()=>{
    axios.get('https://expensetracker-apis-4g7z.onrender.com/get-entries')
    .then(res=>{
  ...
  return(
    ...
    {expenses.map((expense) => (
      <ExpenseItem key={expense.id}  id={expense.id} title={expense.title} amount={expense.amount} deleteExpense = {()=> deleteExpense(expense.id)}/>
    ))}
